...
authors:
  - makerdiary
cover: introducing-nrf-connect-sdk/cover.png
categories:
  - Learn
description: >
...
[nRF Connect SDK Developer Guides](https://wiki.makerdiary.com/nrf52840-connectkit/guides/ncs/){ .md-button .md-button--primary }
